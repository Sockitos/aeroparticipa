...
<a {href}>
	<div
		class="flex flex-row {isSmall ? 'space-x-1' : 'space-x-2'}  items-center justify-center {isLight
			? 'text-blue-light hover:text-white fill-blue-light hover:fill-white'
	...
	>
		...
		<svg
			class={isSmall ? 'h-6 w-6' : 'h-10 w-10'}

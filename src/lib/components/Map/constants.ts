...
export const options: MapOption[] = [
	{
		...
		info: [
			...
			},
			{
				...
				info: [
					{ label: 'Distância a Lisboa', value: '29 km' },
					{ label: 'Tempo a Lisboa', value: '21 mins' }
				]
			},
			{
				label: 'Aeroporto',
			...
			},
			{
				...
				info: [{ label: 'População residente', value: '≈713000' }]
			}
		],
		layers: [
			{
				id: 'ca3',
				label: 'Cones de Aproximação',
				url: 'layers/cones3-4.json',
				style: new Style({
					stroke: new Stroke({ color: 'rgba(50, 50, 50, 1)' }),
	...
	},
	{
		...
		info: [
			...
			{
				label: 'População Potencialmente Vulnerável ao Ruído',
				info: [{ label: 'População residente', value: '≈7130000' }]
			}
		],
		layers: [
			{
		...
		info: [
			{
				...
				info: [
					{ label: 'Frequência num sentido (atual)', value: 'Não Existe' },
					{ label: 'Tempo a Lisboa (atual)', value: 'Não Existe' },
					{ label: 'Tempo a Lisboa (infraestrutura prevista em PNI 2030 e PFN)', value: '18 mins (AV) / 22 mins (CV)' }
				]
			},
			{
				label: 'Rodovia (nas principais vias)',
				info: [
					{ label: 'Distância a Lisboa', value: '51 km' },
					{ label: 'Tempo a Lisboa', value: '37 mins' }
				]
			},
			{
				label: 'Aeroporto',
			...
			{
				label: 'População Potencialmente Vulnerável ao Ruído',
				info: [{ label: 'População residente', value: '≈5500' }]
			}
		],
		layers: [
			{
		...
		info: [
			{
				label: 'Ferrovia',
				info: [
					{ label: 'Frequência num sentido (atual)', value: '93 mov/dia' },
					{ label: 'Tempo a Lisboa (atual)', value: '1h 23 mins' },
					{ label: 'Tempo a Lisboa (infraestrutura prevista em PNI 2030 e PFN)', value: '32 mins (AV)' }
				]
			},
			{
				label: 'Rodovia (nas principais vias)',
				info: [
					{ label: 'Distância a Lisboa', value: '94 km' },
					{ label: 'Tempo a Lisboa', value: '1h 07 mins' }
				]
			},
			{
				label: 'Aeroporto',
			...
			{
				label: 'População Potencialmente Vulnerável ao Ruído',
				info: [{ label: 'População residente', value: '≈567000' }]
			}
		],
		layers: [
			{
		...
		info: [
			{
				label: 'Ferrovia',
				info: [
					{ label: 'Frequência num sentido (atual)', value: '25 mov/dia' },
					{ label: 'Tempo a Lisboa (atual)', value: '1h 23 mins' },
					{ label: 'Tempo a Lisboa (infraestrutura prevista em PNI 2030 e PFN)', value: '32 mins (AV)' }
				]
			},
			{
				...
				info: [
					{ label: 'Distância a Lisboa', value: '94 km' },
					{ label: 'Tempo a Lisboa', value: '1h 05 mins' }
				]
			},
			{
				label: 'Aeroporto',
			...
			{
				label: 'População Potencialmente Vulnerável ao Ruído',
				info: [{ label: 'População residente', value: '≈11000' }]
			}
		],
		layers: [
			{
	...
	},
	{
		...
		info: [
			...
			{
				label: 'População Potencialmente Vulnerável ao Ruído',
				info: [{ label: 'População residente', value: '≈564000' }]
			}
		],
		layers: [
			{
		...
		info: [
			{
				label: 'Ferrovia',
				info: [
					{ label: 'Frequência num sentido (atual)', value: '5 mov/dia' },
					{ label: 'Tempo a Lisboa (atual)', value: '59 mins' },
					{
						label: 'Tempo a Lisboa (infraestrutura prevista em PNI 2030 e PFN)',
						value: '19 mins (AV) / 25 mins (CV)'
					}
				]
			},
			{
				...
				info: [
					...
					{ label: 'Tempo a Lisboa', value: '49 mins' }
				]
			},
			{
				label: 'Aeroporto',
	...
	},
	{
		...
		info: [
			...
			},
			{
				...
				info: [
					{ label: 'Distância a Lisboa', value: '70 km' },
					{ label: 'Tempo a Lisboa', value: '48 mins' }
				]
			},
			{
				label: 'Aeroporto',
...
export const layerGroups: MapLayerGroup[] = [
	{
		...
		layers: [
			{
				id: 'rnap',
				label: 'Rede Nacional de Áreas Protegidas',
				url: 'layers/rnap.json',
				style: new Style({
					stroke: new Stroke({ color: 'rgba(16, 92, 6, 1)' }),
					fill: new Fill({ color: 'rgba(16, 92, 6, 0.2)' })
				}),
				stroke: 'rgba(16, 92, 6, 1)',
				fill: 'rgba(16, 92, 6, 0.2)'
			},
			{
				id: 'zpe',
				label: 'Zona de proteção especial',
				url: 'layers/zpe.json',
				style: new Style({
					stroke: new Stroke({ color: 'rgba(53, 138, 20, 1)' }),
					fill: new Fill({ color: 'rgba(53, 138, 20, 0.2)' })
				}),
				stroke: 'rgba(53, 138, 20, 1)',
				fill: 'rgba(53, 138, 20, 0.2)'
			},
			{
				id: 'zec',
				label: 'Zona especial de conservação',
				url: 'layers/sic.json',
				style: new Style({
					stroke: new Stroke({ color: 'rgba(245, 174, 20, 1)' }),
					fill: new Fill({ color: 'rgba(245, 174, 20, 0.2)' })
				}),
				stroke: 'rgba(245, 174, 20, 1)',
				fill: 'rgba(245, 174, 20, 0.2)'
			},
			{
				id: 'ramsar',
				label: 'Sítios RAMSAR',
				url: 'layers/ramsar.json',
				style: new Style({
					stroke: new Stroke({ color: 'rgba(10, 183, 209, 1)' }),
					fill: new Fill({ color: 'rgba(10, 183, 209, 0.2)' })
				}),
				stroke: 'rgba(10, 183, 209, 1)',
				fill: 'rgba(10, 183, 209, 0.2)'
			},
			{
				id: 'rb',
				label: 'Reserva de Biosfera',
				url: 'layers/biosfera.json',
				style: new Style({
					stroke: new Stroke({ color: 'rgba(117, 66, 6, 1)' }),
					fill: new Fill({ color: 'rgba(117, 66, 6, 0.2)' })
				}),
				stroke: 'rgba(117, 66, 6, 1)',
				fill: 'rgba(117, 66, 6, 0.2)'
			}
		]
	},
	{
		...
		layers: [
			{
				id: 'rodo',
				label: 'Rodovia',
				url: 'layers/rodovia.json',
				style: new Style({ stroke: new Stroke({ color: '#000000', width: 2 }) }),
				stroke: '#000000'
			},
			{
				id: 'ferro',
				label: 'Ferrovia',
				url: 'layers/ferrovia.json',
				style: new Style({ stroke: new Stroke({ color: '#0000ff', width: 2 }) }),
				stroke: '#0000ff'
			},
			{
				id: 'ferrop',
				label: 'Ferrovia prevista',
				url: 'layers/ferrovia_prev.json',
				style: new Style({ stroke: new Stroke({ color: '#0000ff', width: 2, lineDash: [5, 5] }) }),
				stroke: '#0000ff',
				dashed: true
			}
		]
		...
		layers: [
			{
				id: 'ra',
				label: 'Restrição aérea',
				url: 'layers/restricao.json',
				style: new Style({
					stroke: new Stroke({ color: 'rgba(231, 92, 0, 1)' }),
					fill: new Fill({ color: 'rgba(231, 92, 0, 0.1)' })
				}),
				stroke: 'rgba(231, 92, 0, 1)',
				fill: 'rgba(231, 92, 0, 0.2)'
			}
		]
	}
];

	...
	<ol class="marker:text-blue-accent marker:font-bold list-decimal list-outside space-y-5">
		<li>
			...
			<p>
				...
				na economia global. Essa integração requer uma infraestrutura aeroportuária eficiente que garanta
				uma elevada conectividade internacional.
			</p>
		</li>
		<li>
			<p class="pb-2 font-bold">
			...
			<p>
				...
				que vão usar o aeroporto; por outro lado os residentes na vizinhança de um aeroporto vão sofrer
				mais impactes negativos no seu bem-estar devido ao ruído e à afetação psicológica, com efeitos
				na saúde humana.
			</p>
		</li>
		<li>
			...
			<p>
				...
				O aeroporto de Lisboa tem também uma função de hub internacional mas necessita de condições de
				expansão que permitam o seu funcionamento com mais qualidade e eficiência.
			</p>
		</li>
		<li>
			<p class="pb-2 font-bold">
			...
			<p>
				...
				de Portugal, a alta velocidade não é alternativa para ligar Portugal ao centro da Europa.
			</p>
		</li>
		<li>
			...
			<p>
				...
				Por outro lado, as infraestruturas existentes carecem de ampliação e adaptação ao aumento da

...
<svelte:head>
	<title>AeroParticipa - FAQ</title>
</svelte:head>

<PageHeader>FAQ's<br />Perguntas Frequentes</PageHeader>
<PageContainer>
	<p>
		As FAQ (frequently asked questions em inglês) têm surgido em diversos media, ou em mensagens enviadas diretamente à CTI.
		O objetivo das FAQ é manter os agentes interessados, e o público em geral, informados e esclarecidos.
		As FAQ irão sendo atualizadas até final de Janeiro.
		Sugerimos a consulta das FAQ sempre que tenha uma dúvida sobre os resultados apresentados no Relatório Preliminar da avaliação estratégica sobre o aumento da capacidade aeroportuária na região de Lisboa – a resposta que procura pode já estar disponível.
			</p>
	<h3>PT1 - Estudo de Procura</h3>
	<ol class="space-y-4">
		<li>
			<p><b> <h4>As previsões de crescimento do número de passageiros são credíveis?</h4></b></p>
			<p>
				Sim, ainda que não sejam esperadas nas próximas décadas taxas de crescimento do transporte aéreo tão fortes como no passado recente, todas as entidades do sector apontam para que este continue a crescer de uma forma sustentada.
O volume de passageiros na última década no AHD duplicou entre 2012 e 2019, a uma taxa de crescimento anual superior a 10% ao ano. Os valores de crescimento da procura aeroportuária ao longo do período entre 2013 e 2019 foram sempre superiores a 2 milhões de passageiros ao ano, atingindo-se o valor acrescido de 4 milhões de passageiros no ano de 2017. A análise histórica da evolução das taxas de crescimento registadas no Aeroporto Humberto Delgado face às taxas de crescimento do volume de passageiros na região europeia mostra que as taxas de crescimento em Lisboa foram sistematicamente o dobro das observadas naquela região ao longo da última década.
As projeções desenvolvidas assumem que essa diferença diminuirá até 2050, passando do dobro para zero. Considerando esta convergência ajustaram-se as taxas de crescimento projetadas pelas diferentes entidades internacionais até 2050 para o crescimento de passageiros na região europeia. O crescimento anual projetado para Lisboa no cenário baixo até 2050 é de 2,81%, no cenário central de 3,77% e no cenário alto de 4,71%, todas elas muito mais reduzidas do que as verificadas na última década no AHD.
Assim, em 25 anos, as projeções apontam para que o fator de crescimento do número de passageiros possa ser de 2,1 a 3,5 mais do que o  movimento atual. Para 2086, horizonte muito dilatado, considerou-se o ajustamento da curva logística até aquele ano, os rácios de procura variam entre 3,6 a 4,6 mais do que o movimento de passageiros atual.
		...
		<li>
			<p>
				<b>
					<h4>As previsões de crescimento são consistentes com outros estudos ?</h4>
				</b>
			</p>
			<p>
...
Outros estudos mais recentes apontam para valores de procura mais elevados. O estudo da Roland Berger de 2016, para a Autoridade Nacional de Aviação Civil (ANAC), indicava uma procura previsível de 50 milhões de passageiros por ano na Região de Lisboa para 2050. O estudo de 2022, integrando já a informação relativa à redução de procura associada à situação pandémica, da Confederação do Turismo de Portugal, adiantava uma procura de 40 milhões de
passageiros ano para 2035.
		...
		<li>
			<p>
				<b>
					<h4>As previsões de crescimento são compatíveis com a pressão turística na região de Lisboa?</h4>
				</b>
			</p>
			<p>
				Sim, a relação entre o número de turistas e o número de habitantes era, em 2019, de 6 para 1 em Lisboa, enquanto no Porto era de 9 para 1 (cf. https://www.holidu.co.uk/magazine/european-cities-overtourism-index). Se admitirmos o crescimento da população da AML para 2050 e os valores projetados do número de passageiros no cenário central, aquele valor seria de 15 para 1, o que, em 2019, corresponde a uma situação entre a posição de Reiquejavique (16) e Florença (13).			</p>
		</li>
		<li>
			<p>
				<b>
					<h4>As distintas localizações apresentam valores de procura diferentes?</h4>
				</b>
			</p>
			<p>
				Sim, essas diferenças são o resultado do afastamento da nova localização em relação ao AHD, a data de início de operação da nova infraestrutura e a operação em regime dual.
O tempo de acesso ao aeroporto influencia a procura de transporte aéreo, tanto para residentes como para visitantes, reduzindo-se a procura à medida que aumentam os tempos de acesso. Por outro lado, a deslocalização altera igualmente as condições de competição entre os vários aeroportos, como ocorre no caso presente com os aeroportos do Porto e Faro em competição com o de Lisboa, sobretudo para passageiros da região Centro, no caso do Porto, e do Alentejo, no caso de Faro.
O atraso no início de operação da nova infraestrutura agrava os custos da procura não atendida, quer por falta de slots quer por deficientes condições de serviço. Quando se inicia a operação do novo aeroporto, a procura não será a que se verificaria num cenário sem constrangimentos de capacidade dado que a recuperação da procura perdida não será instantânea. Assim, quanto maior for o atraso no início da operação maiores serão as perdas de procura e mais lenta será a sua recuperação.
Por fim, a operação em regime dual condiciona a procura dos passageiros em trânsito, nomeadamente para aqueles em que o voo anterior chega a um dos aeroportos e o voo posterior parta do outro aeroporto, mas também para todos os que optam por realizar a sua transferência num aeroporto menos congestionado.

			</p>
		</li>
	</ol>
	<h3>PT2 - Planeamento Aeroportuario</h3>
	<ol class="space-y-4">
		<li>
			<p><b> <h4>Qual o Futuro do transporte aéreo com as alterações climáticas?</h4></b></p>
			<p>
		...
		<li>
			<p>
				<b>
					<h4>Quais as razões porque opções muito debatidas, como a Ota, ficaram de fora?</h4>
				</b>
			</p>
			<p>
		...
		<li>
			<p>
				<b>
					<h4>Que custos devem ser considerados para manter apenas o Aeroporto Humberto Delgado ? </h4>
				</b>
			</p>
			<p>
		...
		<li>
			<p>
				<b>
					<h4>O que é preciso fazer urgentemente em AHD?</h4>
				</b>
			</p>
			<p>
...
Acresce que esta reduzida vida útil nos conduzirá a um cenário em que teremos 3 aeroportos a médio prazo, o que não é aceitável porque aumenta muito os custos operacionais dos vários agentes envolvidos, reduzindo, necessariamente, a qualidade global dos serviços prestados.  Do lado aeronáutico a oção AHD + Montijo nunca poderá ultrapassar 80 mvts/hora, devido à capacidade limitada do espaço aéreo, cuja análise detalhada pode ser encontrada no relatório produzido pela NAV (anexo 9 do PACARL). De acordo com os estudos de procura realizados (PT1 - Relatório 3, Anexo 3) esta capacidade de 80 mov/h permitirá satisfazer uma procura até 61.5 Milhões de passageiros.
		...
		<li>
			<p>
				<b>
					<h4>Quais as fragilidades de Beja?</h4>
				</b>
			</p>
			<p>
		...
		<li>
			<p>
				<b>
					<h4> O Aeroporto de Santarém é inviabilizado por razões de segurança relativas à Navegação Aérea?</h4>
				</b>
			</p>
			<p>
		...
		<li>
			<p>
				<b>
					<h4>Qual a ligação estratégia hub com futuro da TAP?</h4>
				</b>
			</p>
			<p>
	...
	<h3>PT3 - Acessibilidades</h3>
	<ol class="space-y-4">
		<li>
			<p><b> <h4>O aeroporto no Campo de Tiro de Alcochete  desvia a Linha de Alta Velocidade Lisboa – Porto, e obriga os passageiros que se deslocam entre aquelas cidades a contornar o Rio Tejo por nascente, entre o Carregado e a Estação do Oriente, atravessando a Terceira Travessia do Tejo, alongando deste modo o percurso e o tempo de viagem?</h4></b></p>
			<p>
		...
		<li>
			<p>
				<b>
					<h4>Os passageiros oriundos das Regiões Norte, Centro, Alentejo e Algarve, que se dirijam ao aeroporto no Campo de Tiro de Alcochete têm de passar, forçosamente, pela cidade de Lisboa, antes de se dirigirem ao novo aeroporto?</h4>
				</b>
			</p>
			<p>
		...
		<li>
			<p>
				<b>
					<h4>A localização do aeroporto em Alcochete torna mais caro o projeto da alta velocidade previsto no Plano Ferroviário Nacional?</h4>
				</b>
			</p>
			<p>
		...
		<li>
			<p>
				<b>
					<h4>Se, por qualquer motivo, o projeto da Alta Velocidade em Portugal e a Terceira Travessia do Tejo não avançarem nas próximas décadas, serão motivo suficiente para inviabilizar a construção do aeroporto no Campo de Tiro de Alcochete?</h4>
				</b>
			</p>
			<p>
...
Aliás, idêntica questão, porque as razões subjacentes são rigorosamente iguais, teria de ser considerada para as opções de localização do Montijo e de Vendas Novas. Em Santarém o caso é diferente, porque a linha de alta velocidade, servindo Leiria, não passa naquela cidade.
		...
		<li>
			<p>
				<b>
					<h4>Quais os custos das acessibilidades que foram imputados a cada opção estratégica em avaliação?</h4>
				</b>
			</p>
			<p>
		...
		<li>
			<p>
				<b>
					<h4>Quais os cronogramas de construção das acessibilidades?</h4>
				</b>
			</p>
			<p>
				Os cronogramas para a construção das ligações rodo e ferroviárias de cada opção estratégica em avaliação apresentam-se de forma detalhada no Anexo 2 do Relatório Síntese do PT3 – Acessibilidades (págs. 74 e 75).
Para as ligações rodoviárias estima-se, consoante a opção estratégica em análise, um período de 10 a 14 meses, correspondente à realização dos Estudos de Impacte Ambiental e ao desenvolvimento das fases de projeto, e de 12 a 20 meses para a execução das obras rodoviárias.
Para as ligações ferroviárias estima-se, consoante a opção estratégica em análise, um período de 16 a 18 meses, correspondente à realização dos Estudos de Impacte Ambiental e ao desenvolvimento das fases de projeto, e de até 24 meses para a execução das obras ferroviárias.
Como estas obras podem, e devem, avançar em paralelo com a construção do próprio aeroporto, não afetam o seu cronograma global de realização, que se estende por um período muito mais alargado de tempo, qualquer que seja a opção estratégica a considerar.
		...
		<li>
			<p>
				<b>
					<h4>Quem paga as acessibilidades?</h4>
				</b>
			</p>
			<p>
				As infraestruturas rodoviárias e ferroviárias de ligação do novo aeroporto à rede existente rodoviária, ou às redes ferroviárias existentes, programadas e/ou planeadas de acordo com o Plano Ferroviário Nacional, deverão ser pagas pelo respetivo promotor aeroportuário.
No caso das ligações rodoviárias, envolvendo as autoestradas sob a exploração da BRISA, o respetivo contrato de concessão (RCM 198-B/2008 de 31 de dezembro) prevê que os custos destas ligações sejam suportados pela concessionária (referido em nota de pé de página no Relatório Síntese do PT3 – Acessibilidades, pág. 45).
	...
	<ol class="space-y-4">
		<li>
			<p><b> <h4>Existe alguma boa localização para um novo aeroporto de Lisboa, do ponto de vista ambiental?</h4></b></p>
			<p>
...
Na perspetiva da adaptação colocam-se prioridades na resiliência das infraestruturas, nomeadamente através do reforço de segurança aos efeitos negativos dos fenómenos extremos. Face aos efeitos gerados pelas alterações climáticas (por exemplo a previsível subida do nível médio da água do mar, ocorrência de fenómenos extremos como as inundações, entre outros) a localização das infraestruturas de transporte aéreo, como os aeroportos devem observar-se em zonas menos vulneráveis, sob pena de ameaçarem a segurança da atividade aeronáutica, e dos seus utilizadores.
		...
		<li>
			<p>
				<b>
					<h4>Quais os tipos de custos ambientais associados à manutenção do AHD? </h4>
				</b>
			</p>
			<p>
		...
		<li>
			<p><b> <h4>O que é preciso fazer urgentemente no AHD?</h4></b></p>
			<p>
				Do ponto de vista ambiental, o AHD deve ser fechado assim que possível, ou pelo menos reduzir significativamente o número de voos, em especial os noturnos. Deve também ser garantida a plena execução das medidas previstas no Plano de Ações de Gestão e Redução de Ruído adotado pela ANA, e assegurada a expansão da monitorização ambiental atual a outros poluentes que, devido às suas características, podem ter efeitos adversos na saúde humana e no ambiente, nomeadamente, as partículas ultrafinas, o carbono negro, os metais, e outros Hidrocarbonetos Aromáticos Policíclicos (HAPs) e a sua comunicação à sociedade. Do ponto de vista operacional foram propostas um conjunto de ações de melhoria para o AHD, que podem ser lidas no relatório de curto-prazo (Anexo 10 do relatório PACARL)
			</p>
		</li>
		<li>
			<p>
				<b>
					<h4>Quais os fundamentos ambientais que explicam porque o Montijo não pode ser solução provisória até o campo de tiro de Alcochete (CTA) avançar, como chegou a ser pensado?</h4>
				</b>
			</p>
			<p>
...
Já no EIA do MTJ se tinha identificado a forte perturbação da avifauna. Por este motivo o EIA considera um conjunto de medidas de mitigação e de compensação inéditas no país. Embora possam ter passado despercebidas, algumas das medidas de mitigação requeridas pelo ICNF podem dificultar o regular funcionamento da atividade aeronáutica dadas as exigências de proteção dos movimentos naturais das aves. As alegações que já lá está uma infraestrutura aeronáutica são compreensíveis, mas é importante salientar que a dimensão e o número de movimentos de aeronaves é atualmente manifestamente inferior ao que será com a instalação de um aeroporto no MTJ (mesmo que apenas com uma única pista).
		...
		<li>
			<p>
				<b>
					<h4>Quais as grandes diferenças do ponto de vista ambiental entre CTA e Vendas Novas? </h4>
				</b>
			</p>
			<p>
...
É verdade que a afetação de sobreiros é elevada em CTA (cerca de 42 000). Ainda assim a CTI, através do trabalho do PT2 identificou a possibilidade de deslocar para sul as primeiras pistas no CTA, permitindo com isso a redução significativa da afetação do número de sobreiros.
		...
		<li>
			<p><b> <h4>O Campo de Tiro de Alcochete tem mais riscos ambientais do que Santarém? </h4></b></p>
			<p>
		...
		<li>
			<p>
				<b>
					<h4>O novo aeroporto afeta 250.000 sobreiros em Alcochete?</h4>
				</b>
			</p>
			<p>
				Não. A área de implantação prevista para o aeroporto no CTA afeta cerca de 42 000 sobreiros.
Ainda assim a CTI, através do trabalho do PT2 identificou a possibilidade de deslocar para sul as primeiras pistas em Alcochete, permitindo com isso a redução significativa da afetação do número de sobreiros.

			</p>
		</li>
	</ol>
	<h3>PT5 - Estudos Economico-Financeiros</h3>
	<ol class="space-y-4">
		<li>
			<p><b> <h4>O aeroporto paga-se a si próprio?</h4></b></p>
			<p>
...
O VAL positivo corresponde ao valor que um promotor estaria disposto a pagar pela concessão com início em 2024 e conclusão em dois dos horizontes temporais estudados (2062 e 2082).
			</p>
		</li>
		<li>
			<p>
				<b>
					<h4>O VAL calculado na análise financeira corresponde ao VAL para o atual concessionário (ANA Aeroportos de Portugal)?</h4>
				</b>
			</p>
			<p>
				Não. O VAL calculado assume taxas aeroportuárias fixas a preços constantes, o que é diferente do estipulado no Contrato de Concessão (CC). Adicionalmente, não se considera o mecanismo de partilha de receitas brutas previsto no CC.
Ou seja, na avaliação financeira, o atual concessionário ponderará os benefícios resultantes da renegociação do mecanismo de regulação das taxas aeroportuárias com a alternativa de manter as atuais condições contratuais, considerando todos os efeitos da decisão, nomeadamente os que resultam do CC.
		...
		<li>
			<p>
				<b>
					<h4>Quem determina as taxas aeroportuárias?</h4>
				</b>
			</p>
			<p>
				AAs taxas aeroportuárias são compostas por um conjunto variado e extenso de diferentes taxas (e.g. taxas de aterragem e descolagem, taxas de estacionamento, taxas de serviço aos passageiros, entre várias outras).
				As taxas aeroportuárias são revistas anualmente, sendo propostas pelo concessionário (ANA Aeroportos de Portugal) e sujeitas à aprovação do regulador ANAC. Se existir divergência no cálculo, as taxas a aplicar são as definidas pela ANAC. A proposta do concessionário, e a análise da ANAC, são balizadas pela aplicação de um mecanismo previsto no contrato de concessão.
				Esse mecanismo fixa uma variação média máxima para o conjunto das taxas. O concessionário tem liberdade para, dentro do limite médio máximo admissível, alterar cada uma das taxas de forma a otimizar, do ponto de vista operacional e ambiental, a utilização do aeroporto.
		...
		<li>
			<p>
				<b>
					<h4>Um novo aeroporto significa taxas aeroportuárias mais elevadas?</h4>
				</b>
			</p>
			<p>
				As taxas aeroportuárias são um elemento relevante para o financiamento dos investimentos de aumento de capacidade. Existem receitas adicionais, como as que resultam das atividades não aeroportuárias, de que são exemplo o aluguer de espaços e as receitas do retalho ou do estacionamento automóvel.
Em tese, para garantir o mesmo retorno sobre o investimento, quanto menor o volume de investimento necessário, menor o valor das taxas. Para efeitos de comparação das opções, a análise financeira realizada considerou que as taxas se manteriam fixas a preços constantes, variando apenas de acordo com a inflação, de que resultou a conclusão que, para esse nível das taxas (constantes), todas as opções estratégicas não necessitam de subsídios públicos,
mas conduzem a níveis de retorno distintos para o concessionário.
O pressuposto de manter as taxas fixas (a preços constantes) resultou da constatação de que o mecanismo atual previsto no contrato de concessão não é adequado e, simultaneamente, garantir uma comparação neutra entre as várias opções.
Todavia, a relevância das taxas aeroportuárias não se restringe ao financiamento. São, também, um importante instrumento de competitividade para o aeroporto. Taxas mais baixas tornam o aeroporto mais atrativo e, consequentemente, promovem mais ligações, mais conectividade e mais passageiros.
			</p>
		</li>
	</ol>
	<h3>PT6 - Juridico</h3>
	<ol class="space-y-4">
		<li>
			<p><b> <h4>O contrato é uma condicionante da localização do novo aeroporto?</h4></b></p>
			<p>
				Sim. O contrato de concessão está em vigor e tem um capítulo sobre a expansão aeroportuária da
região de Lisboa, pelo que qualquer solução que a  pretenda concretizar tem de considerar as cláusulas do contrato.
		...
		<li>
			<p>
				<b>
					<h4>O que é o direito de opção da Concessionária no contexto da expansão aeroportuária da Região de Lisboa? </h4>
				</b>
			</p>
			<p>
		...
		<li>
			<p>
				<b>
					<h4>O direito de opção é absoluto?</h4>
				</b>
			</p>
			<p>
		...
		<li>
			<p>
				<b>
					<h4>Como pode ser exercido o direito de opção/preferência pela Concessionária? </h4>
				</b>
			</p>
			<p>
				No presente momento, o contrato admite duas formas de desenvolver novas estruturas, dentro do limite territorial (75Km):
a) como NAL; ou
b) como Alternativa da Concessionária para o NAL (ver questão sobre Alternativa da Concessionária).
		...
		<li>
			<p>
				<b>
					<h4>Há direito de opção para lá dos 75km?</h4>
				</b>
			</p>
			<p>
		...
		<li>
			<p>
				<b>
					<h4>Quando termina o direito de opção?</h4>
				</b>
			</p>
			<p>
				O direito de opção, de acordo com o contrato, termina quando verificada uma das seguintes hipóteses:
a) A Concessionária comunicou ao Concedente não ter capacidade para rever a sua Candidatura ao NAL nos termos por aquele solicitados; ou
b) A ausência de Aprovação Final do NAL pelo Concedente no prazo de 12 meses (ou de 18 meses, em caso de prorrogação) a contar da data da Aprovação Provisória da Candidatura ao NAL (ver questão sobre o procedimento do NAL).
		...
		<li>
			<p>
				<b>
					<h4>O que significa o Termo da Opção?</h4>
				</b>
			</p>
			<p>
				O Termo da Opção liberta o concedente para avançar com a Alternativa do Concedente.
Quando ocorrer, pode haver recurso a terceiros, na área que entender mais adequada, podendo proceder à modificação do Contrato ou, na falta de acordo com a Concessionária, resolver o contrato, com compensação equivalente à do incumprimento do concedente.
...
De forma muito breve, correriam 6 meses para o Relatório Inicial, 30 dias para requerer apresentação de candidatura, 36 meses para apresentação de candidatura, 90 dias para aprovação provisória e 12 meses para aprovação final). Isto sem prorrogações nem pedidos de esclarecimentos. Decorridas estas fases, e chegado o momento da aprovação final sem que tal ocorra, verifica-se o Termo da Opção.
		...
		<li>
			<p>
				<b>
					<h4>Quando pode surgir a Alternativa da Concessionária?</h4>
				</b>
			</p>
			<p>
		...
		<li>
			<p>
				<b>
					<h4>O que implica a Alternativa da Concessionária se for aceite?</h4>
				</b>
			</p>
			<p>
		...
		<li>
			<p>
				<b>
					<h4>Quais são as formas de reequilíbrio financeiro?</h4>
				</b>
			</p>
			<p>
				Existem vários instrumentos para operar o reequilíbrio financeiro: alteração de taxas sujeitas a regulação económica, nos termos do anexo 12 e com consulta à reguladora; comparticipação ou compensação pelo Concedente; prorrogação de prazo da concessão ou qualquer outra forma acordada entre as partes.
Importa sublinhar que o contrato impõe que a Concessionária demonstre que se está a esforçar para mitigar os efeitos da modificação.
...
A caducidade de atos jurídicos significa que eles deixam de produzir efeitos. Portanto o Memorando e os Acordos Complementares não estão em vigor desde 12.04.2021. [de acordo com a documentação que a CTI e seus colaboradores tiveram acesso]. Paralelamente ao processo negocial descrito, foi iniciado o procedimento do NAL: 2018, notificação de Fator de Desencadeamento (cláusula 44.2 do contrato); a Concessionária foi notificada para elaborar o Relatório Inicial (no mês subsequente); em maio, a título excecional, porque a Alternativa da Concessionária estava a correr, o Concedente suspendeu o prazo de apresentação do referido Relatório. Esta suspensão chegou a ser prorrogada várias vezes. Apesar da complexidade jurídica de interpretação de cláusulas sobre a suspensão do prazo, a solução que melhor acomoda o princípio da boa fé é a que considera que retoma do prazo para apresentação do Relatório Inicial apenas ocorrerá se e quando o Concedente notificar a Concessionária para o efeito. Portanto, o procedimento do NAL está na disponibilidade do Concedente, não se tendo verificado ainda o Termo da Opção.
		...
		<li>
			<p>
				<b>
					<h4>O que acontece se o Concedente não respeitar o Direito de Opção da Concessionária?</h4>
				</b>
			</p>
			<p>
				Se o Concedente não respeitar o direito de opção da Concessionária porque, por exemplo, desenvolve ou autoriza que terceiros desenvolvam um aeroporto dentro dos 75Km e antes do Termo da Opção, incumpre o contrato.
Nessa hipótese:
a) Concessionária teria direito à reposição do equilíbrio financeiro, desde que verificadas todas as condições contratuais aplicáveis, incluindo o Limite Mínimo para Acionar o Reequilíbrio;
b) se o reequilíbrio fosse muito oneroso para o Concedente, este poderia resolver o contrato, isto é, pôr fim ao contrato, cumprindo formalidades de notificação e pagando uma indemnização à Concessionária que seria calculada como se a resolução fosse por incumprimento do Concedente.
		...
		<li>
			<p>
				<b>
					<h4>Em que circunstâncias pode haver resolução do contrato de concessão?</h4>
				</b>
			</p>
			<p>
				O contrato pode ter fim, através de resolução, nas seguintes situações com relevo para este momento:
a) por razões de interesse público, caso em que a resolução toma o nome de resgate – ver PT6 FAQ nº16.
b) por incumprimento da Concessionária (resolução sancionatória) de determinadas obrigações identificadas no contrato;
c) no âmbito do procedimento do NAL, verificado o Termo da Opção;
d) incumprimento do Concedente no contexto de violação do Termo da Opção, caso a indemnização devida se mostrasse excessivamente onerosa para o Concedente.
Importa sinalizar que a resolução do contrato é um cenário disruptivo grave porque afetaria todos os aeroportos geridos pela Concessionária.
		...
		<li>
			<p>
				<b>
					<h4>Quais são as obrigações da Concessionária que, uma vez não cumpridas, conferem o
						direito à resolução do contrato?
						</h4>
				</b>
			</p>
			<p>
				Estão previstas no contrato e são as seguintes (previstas na cláusula 62.4 aí descritas com mais detalhes):
- qualquer facto que confira, nos termos do CCP, o direito do Concedente a resolver o contrato como sanção por incumprimento;
-incumprimento grave das obrigações contratuais, incluindo qualquer incumprimento que (não sendo sujeito ao regime das multas contratuais previsto no anexo 7) não acabe no prazo de 6 meses a contar da notificação do Concedente ou se verifique em 5 situações consecutivas da mesma natureza;
-incumprimento integral ou parcial do pagamento inicial;
-incumprimento dos contratos de financiamento;
-dissolução ou pedido de declaração de insolvência da Concessionária;
-cessação da prestação de atividades e serviços aeroportuários ou o abandono, total ou parcial, da exploração de qualquer aeroporto ou das obrigações de desenvolvimento (após o seu início);
-incumprimento grave de uma declaração ou garantia prevista na cláusula 4.ª;
-incumprimento das cláusulas 10.ª (forma e regime jurídico da concessionária) e 54.ª (direitos de prestar atividades e serviços aeroportuários);
-incumprimento de obrigações relacionadas com rácios de dívida;
-cobrança de taxas aeroportuárias ou outras contrapartidas em montantes superiores aos permitidos pelo anexo 12;
- falta de seguros; e aplicação de multas contratuais, durante 2 ou mais anos consecutivos (cláusula 59.3);
Contudo, o contrato prevê que, antes da resolução,
a) notificar o concedente;
b) sanar o incumprimento, sendo possível, dentro de determinados prazos;
c) pode haver acordo entre concessionária e concedente para a sanação;
d) se não houver sanção nos prazos ou dentro do acordo da anterior alínea, o concedente pode então resolver o contrato e/ou intervir na concessão (cláusula 62.5).
		...
		<li>
			<p>
				<b>
					<h4>Se a Concessionária não concordar com a opção de localização do Concedente, pode acionar-se o mecanismo do resgate?</h4>
				</b>
			</p>
			<p>
				Neste momento, não.
O resgate é o nome que toma o instrumento jurídico que põe fim ao contrato por razões de interesse público. Assim, nos termos do contrato (cláusula 64.ª) para operar o resgate é preciso:
a) que se verifique, de forma fundamentada, isto é, explicada com factos e argumentos, o interesse público (de que serve melhor o interesse público a exploração aeroportuária passar para o Estado); 
b) ter decorrido o prazo de 25 anos sobre a data da assinatura, ou seja, tendo sido o contrato assinado em 2012, só pode ocorrer em 2037;
c) comunicar, por escrito, à Concessionária com 6 meses de antecedência.
Não se verificam, portanto, todos os requisitos para um resgate, desde logo o prazo. A eventual não concordância da Concessionária, se for caso de exercício do Direito de Opção, com a localização escolhida pelo Concedente, deve ser tratada à luz dos mecanismos contratuais previstos para a expansão aeroportuária da região de Lisboa.
		</p>
		</li>
		<li>
			<p>
				<b>
					<h4>O resgate tem custos?</h4>
				</b>
			</p>
			<p>
